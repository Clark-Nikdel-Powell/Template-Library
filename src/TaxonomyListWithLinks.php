...
class TaxonomyListWithLinks extends TaxonomyList {
	 ...
	 * @param string $after
	 */
	public function __construct( $name = 'taxonomy-list-with-links', $taxonomy = null, $delimiter = ', ', $data = null, $tag = 'div', array $attributes = [], $before = '', $prepend = '', $append = '', $after = '' ) {

		parent::__construct( $taxonomy, $delimiter, $data, $name, $tag, $attributes, $before, $prepend, $append, $after );
